...
describe("basic-1", () => {
  ...
  it("Creates and initializes an account in a single atomic transaction (simplified)", async () => {
    ...
    console.log("a myacc balance",await provider.connection.getBalance(myAccount.publicKey));
